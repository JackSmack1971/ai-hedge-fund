...
from src.tools.api import _make_api_request, get_prices, _REQUEST_TIMEOUT
...
class TestRateLimiting:
    ...
    def test_full_integration(self, mock_get, mock_sleep, mock_cache):
        ...
        mock_200.json.return_value = {
            "ticker": "AAPL",
            "prices": [
                {"time": "2024-01-01T00:00:00Z", "open": 100.0, "close": 101.0,
    ...
    def test_max_retries_exceeded(self, mock_get, mock_sleep):
        ...
        result = _make_api_request(
            "https://api.financialdatasets.ai/test", {"X-API-KEY": "k"}, max_retries=2
        )
