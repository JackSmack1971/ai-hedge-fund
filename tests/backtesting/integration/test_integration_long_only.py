...
def test_long_only_strategy_full_liquidation_cycle():
    ...
    assert (
        portfolio_summary["total_position_value"] == expected_total_position_value
    ...
    assert (
        abs(final_portfolio_value - final_cash) < 0.01
...
def test_long_only_strategy_portfolio_rebalancing():
    ...
    assert (
        portfolio_summary["total_position_value"] >= expected_min_position_value
...
def test_long_only_strategy_multiple_entry_exit_cycles():
    ...
    assert (
        portfolio_summary["total_position_value"] == 0.0
